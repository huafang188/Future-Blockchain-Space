...
const i18nData = {
  ...
  wait_audit: "申請已提交，等待審核",
    ...
    'en': {
        ...
        miner_desc: "Each mining machine has a hash rate of approximately 30 TH/s.",
        buy_miner: "Buy Miner",
  ...
  wait_audit: "Submitted, waiting for audit",
    ...
    'ja': {
        ...
        miner_desc: "各マイニングマシンのハッシュレートは約30 TH/sです。",
        buy_miner: "購入する",
        pay_fee: "電気代支払い",
        m_count: "数量",
        m_yield: "日産量",
  ...
  wait_audit: "申請が送信されました。審査待ちです",
    ...
    'ko': {
        ...
        miner_desc: "각 채굴기는 약 30 TH/s의 해시레이트를 가지고 있습니다.",
        buy_miner: "채굴기 구매",
        pay_fee: "전기료 납부",
        m_count: "수량",
        m_yield: "일일 생산량",
  ...
  wait_audit: "신청이 제출되었습니다. 심사 대기 중입니다",
    ...
    'ru': {
        ...
        miner_desc: "Каждая майнинговая машина имеет хешрейт приблизительно 30 TH/s.",
